...
def main():
    ...
    application.add_handler(CommandHandler("Lista aparcamiento", parking, has_args=False))
    application.add_handler(CommandHandler("Indice €STER", ester, has_args=False))
    print("Listening...")
